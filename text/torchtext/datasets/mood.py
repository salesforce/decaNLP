...
"""['https://saifmohammad.com/WebDocs/EmoInt%20Train%20Data/anger-ratings-0to1.train.txt',\
...
class Mood(data.Dataset):
    ...
    def __init__(self, path, text_field, label_field, subtrees=False,
        ...
        """Create an Mood dataset instance given a path and fields.
